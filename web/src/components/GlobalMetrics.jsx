...
export default function GlobalMetrics({ metrics, status }) {
  ...
  return (
    <div className="dashboard-container">
      ...
      {status === 'offline' && (
        <div className="banner danger-banner">⚠️ 無法與後端 API 伺服器取得連線，全域即時數據可能無法更新。</div>
      )}
    </div>
  );
}
