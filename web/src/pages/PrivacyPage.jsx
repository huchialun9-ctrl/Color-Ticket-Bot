  ...
  return (
    <div className="page docs-page" style={{ textAlign: 'left' }}>
      <div className="docs-header">
        ...
        <p className="muted">胖達CHubbMan 致力於保護您的 Discord 帳號隱私，並確保資料傳輸與儲存的絕對安全。</p>
      </div>

      <div className="docs-content" style={{ marginTop: '24px' }}>
        <section className="docs-section">
          <h2>一、 隱私權政策 (Privacy Policy)</h2>
          <p>當您使用 Discord 帳號登入 胖達CHubbMan 儀表板時，我們會經由 Discord OAuth2 授權取得以下必要的最小資訊：</p>
          <ul>
            <li>
        ...
        <section className="docs-section" style={{ marginTop: '32px' }}>
          ...
          <p>為了確保您的社群數據與金鑰不會外洩，胖達CHubbMan 採用了企業級的防護手段：</p>
          <ul>
            <li>
        ...
        <section className="docs-section" style={{ marginTop: '32px' }}>
          ...
          <p>胖達CHubbMan 使用 Cookies 的唯一目的是為了保障網站的基本運作與提升您的使用體驗。我們使用的 Cookie 具有以下特性：</p>
          <ul>
            <li>
